...
anomalies over the North Pacific; many models (e.g. MRI-CGCM3, IPSL-CM5A) show
positive anomalies, while MPI-ESM-LR a MPI-ESM-MR have negative anomalies
...
A robust difference found between anomalies following split and displaced vortex
events in the vast majority of models and the multi-model mean is that anomalies
...
2-3~hPa across most of Russia. In order to understand this difference,
composites of 100~hPa $Z$ averaged 
