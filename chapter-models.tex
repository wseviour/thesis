...
\begin{figure}
 ...
 models]{Composites of mean sea-level pressure anomalies averaged 0-30 days
   ...
   weighting. The number of events entering each composite is shown in the
   title.}
...
\paragraph{Models representation of the stratospheric polar vortex and
...
aspect ratio or centroid latitude of the vortex.
