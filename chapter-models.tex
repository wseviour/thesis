...
\begin{figure}
 ...
 events in the CMIP5 models.]{Relationship between model resolution and
   ...
   models. Model resolution is shown as horizontal resolution, vertical
   resolution over 5-15~km and 15-30~km, and aspect ratio
   ($\mathrm{d}z$(5-15~km)$ / \mathrm{d}h$. Also shown is the number of SSWs per
   decade, the fraction of SSWs that are splits, and the average NAM at 500~hPa
   0-30 days following SSWs. Histograms for the intersecting quantities are
   shown along the leading diagonal.}
 \label{Fig2}
\end{figure}
