...
have focussed on more localised extreme weather events. \citet{Thompson2002}
found weakenings of the NH stratospheric polar vortex to be associated with an
increased likelihood of extreme cold events over North America, northern Europe
and eastern Asia. \citet{Kolstad2010} and \citet{Tomassini2012} both also found
an association between NH cold air outbreaks and weak stratospheric polar vortex
events. These extreme cold events are often linked with persistent `blocking'
weather patterns,\footnote{These are characterised by a persistent anticyclonic
  anomaly that causes a reversal in the upper-tropospheric meridional gradient
  of a quantity such geopotential height \citep[e.g.,][]{Tibaldi1990}.}  and
several studies have investigated the association between stratospheric
variability and blocking. These have mostly asserted an upwards link, with
blocking events preceeding a weakened polar vortex \citep{ONeill1994

\citep{KoderaChiba1995, Nishii2009}
