...
Despite this near-barotropic appearance, annular mode variabiliy has quite
...
\begin{figure}
 \centering
 \noindent\includegraphics[width=\textwidth]{figures/chapter-intro/Baldwin_Dunkerton_98-99.png}
...
there. However, \citet{Thompson2002a} argued that a long-term strengthening of
the SH stratospheric polar vortex resulting from ozone depletion may be causing
trends in the tropospheric SAM through a dynamical link. This was supported by
...
have focussed on more localised extreme weather events in addition to the
...
upwards link, with blocking events preceeding a weakened polar vortex
\citep{Quiroz1986, Andrews1987, ONeill1994}. More recent studies have further
investigated whether blocking in particular locations preceeds split or
...
\begin{figure}
 \centering
 \noindent\includegraphics[width=\textwidth]{figures/chapter-intro/M13.png}
 \caption[NAM composite from \citet{Mitchell2013}]{Composites of the
   ...
   an event asmeasured at 10~hPa. Contour intervals are 0.25 and the region
...
(such as sea-surface temperatures) may affect both the troposphere and
stratosphere separately. To address this, a number of modelling studies have
been carried out which measure the tropospheric response to some imposed
stratospheric perturbation. These are described in the next section. 
...
found a consistent tropospheric response to an imposed stratospheric torque or
forcing \citep[e.g.,][]{Polvani2002,Norton2003, Taguchi2003}. This tropospheric
response generally resembles the negative phase of the NAO or NAM following a
weakening of the vortex, and as such is consistent with the observational
...
slighly eastwards. Interestingly, they found an almost opposite surface response
...
\begin{figure}
 \centering
 \noindent\includegraphics[width=\textwidth]{figures/chapter-intro/Jung_Barkmeijer.png}
...
simulating a balanced, physical state (for instance, they may not conserve
angular momentum). As such, several studies have taken place using free running
GCMs. \citet{Gerber2008} performed a study in which 
