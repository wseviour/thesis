...
depletion is much less in the NH. Moreover, it has been demonstrated that
interannual variability in wave driving (as measured by
$\mathbf{\nabla\cdot F}$) can account for most of the interannual variability of
ozone depletion through this mechanism \citep{Salby2012}. In the extreme event
of SSWs, the ozone hole can be severely disrupted. This can be seen in Figure
