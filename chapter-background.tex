...
\emph{stratospheric polar vortex}.\footnote{Alternative names for this which
  often appear in the literature are `polar night jet' or `polar night
  vortex'. These names are not used here because the vortex persists outside of
  the polar night.}
...
\citep{Andrews1976,Dunkerton1978,Holton1990}. Under the TEM formalism, the zonal
...
the vortex, mostly depending (though not exclusively; see Section
...
near-surface NAM structure is more zonally asymmetric than the SAM, with
...
the eddy-driven jets. Moreover, stratospheric annular mode variability is
largely confined to winter, while tropospheric variability has a much less
...
highly correlated with SSWs. It is apparent that NAM signal appears to descend
in the case of the latter event (but not the former) and consistent anomalies
remain in the troposphere for approximately one month. This timescale is much
longer than the usual timescales of tropospheric NAM variability
...
wavenumer-1/displaced vortex SSWs.\footnote{Using the method developed in
  ...
  event and the second as a split vortex event. Their different tropospheric NAM
  may therefore be expected, although no firm conclusions should be reached from
  the study just two events.} This result is illustrated in Figure
\ref{fig:M13}, which shows composites of the NAM following the split and
...
\emph{causation}. For example, there may be the possibility that a third factor
...
troposphere but descend to the troposphere after approximately 20
...
slightly eastwards. Interestingly, they found an almost opposite surface response
when a strengthening of the stratospheric polar vortex was imposed. This
indicates that the surface response may be linear, potentially providing some
information about the mechanism responsible for the response, as discussed in
the next section.
...
\citet{Scaife2005} studied the response of the troposphere to a long-term
imposed stratospheric trend. They found that when a long term acceleration of
the stratospheric polar vortex was imposed from the 1960s--1990s, in line with
observations, their model more faithfully reproduced the long-term trend towards
a more positive phase of the NAO over this time. It is however, important to
note that this does not necessarily imply that stratospheric changes were
driving the trend in reality. 
...
to lengthen SAM timescales\footnote{The SAM/NAM timescale is defined as the lag
  (in days) for the autocorrelation to fall by 1/$e$.} during the austral late
...
and long-term trends with improved vertical resolution. Additionally, in a case
study of the cold European winter 2005--2006, \citet{Scaife2008} found increased
blocking activity in a model with greater stratospheric resolution. On the other
hand, in a multi-model comparison of blocking, \citet{Anstey2013} found a
stronger relationship between blocking frequency and
upper-troposphere/lower-stratosphere vertical resolution than with model lid
height. A difficulty of such studies is that there are often several differences
between high- and low-top models besides their vertical resolution (such as
their parametrisation schemes), so it is difficult to pin down any differences
between the simulations to a stratospheric influence alone. \citet{Hardiman2012}
attempted to address this issue by comparing model simulations which differ only
in their vertical resolution above 15~km. They found the climatology and trends
of surface temperature to be largely insensitive to the increased vertical
resolution, although stronger surface anomalies following SSWs and a more
realistic trend in the NAO were found in the high-top model.

Several studies have investigated the influence of the stratosphere on the skill
of short-to-medium-range forecasts (also discussed in Section
\ref{sec:seas-introduction}). These have demonstrated that the stratospheric NAM
can be used to enhance the prediction of the tropospheric NAM up to a month
ahead \citep{Baldwin2003a, Charlton2003, Christiansen2005} and that greater
skill is achieved when forecasts are initialised at the onset of SSWs
\citep{Sigmond2013}. This further adds to the evidence of a downwards causal
link from the stratosphere. 
...
\begin{itemize}
\item\textbf{Baroclinic instability:} \citep{Wittman2007}
\item\textbf{PV inversion}
